...
var object = ['un sabre-laser', 'une vieille barre chocolatée infusée de Force', 'une chaussette orpheline', 'l\'intelligence perdue des Jedi, tombée derrière une machine à café', ];
...
var huttName = ['Zumba', 'Rumba', 'Java', 'JavaScript', 'Barbapapa', ];
...
var phrase1 = randomMajorCharacter + ' se rend sur ' + randomPlanet + ' et y trouve ' + randomObject + ' ayant appartenu à ' + randomSecondaryCharacter + '.';

var phrase2 = 'Au terme ' + randomAction + ', ' + randomMajorCharacter + ' découvre ' + randomSituation + ' ' + randomSecondaryCharacter + '.'
...
'cousin germain du grand-oncle de'
'ami d'enfance de la nourrice de'
'demi-frère de lait du meilleur ami de'
'l'ami dans la Force de'
'la deuxième partie d'une dyade dans la Force avec'


'La galaxie est ' + galaxyState
_ part en quête _ permettant de _.
La Force demande à _ de détruire _ au bénéfice de _ le Hutt.
La cantina de _ est assiégée par _, sous les ordres de _.
Horreur ! _, secrètement ressuscité par _, menace _ sur la planète _.
Poursuivi par des chasseurs de primes impitoyables, _ doit retrouver _ pour accomplir une prophétie de la Force.
Le droïde _ doit recompiler _ sur le vaisseau afin que les Jedi puissent _. Pendant ce temps, les Sith _ sur _.
